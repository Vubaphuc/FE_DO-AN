...
import { useLazyDanhSachVatLieuConHangQuery } from "../../../app/apis/nhanviensuachuaApis/vatLieuNVSCApi";
import { Link } from "react-router-dom";

function DanhSachVatLieuConHangPage() {
                      ...
                      {vatLieuData?.data &&
                        vatLieuData?.data.map((vatLieu, index) => (
                          <tr key={vatLieu?.code}>
                            <td>{count + index + 1}</td>
                            <td>
                              <Link to={`/nhan-vien/sua-chua/vat-lieu/${vatLieu.code}`} className="text-decoration-none">
                                {vatLieu?.code}
                              </Link>
                            </td>
...
export default DanhSachVatLieuConHangPage;
