...
import useDoiMatKhau from "../hook/hookAccount/useDoiMatKhau";

function DoiMatKhau() {
  const { register, handleSubmit, errors, onDoiMatKhau } = useDoiMatKhau();
    ...
    <>
      ...
      >
        <div className="login shadow p-5" style={{ width: 500 }}>
          ...
          <form 
            onSubmit={handleSubmit(onDoiMatKhau)}
